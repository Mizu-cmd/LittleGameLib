...
public class PlayerDamagesAnotherGE extends GameEvent {

    private GamePlayer killer;
    private GamePlayer victim;
    private EntityDamageByEntityEvent event;
    public PlayerDamagesAnotherGE(GameState state, GamePlayer killer, GamePlayer victim, EntityDamageByEntityEvent event) {
        super(victim, state);
        this.victim = victim;
        this.killer = killer;
        this.event = event;
